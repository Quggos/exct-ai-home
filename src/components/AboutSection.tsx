...
const AboutSection = () => {
  ...
  return <section className="exct-section bg-white py-24 relative overflow-hidden">
      {/* Background Elements */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          <div className="lg:col-span-5">
            ...
            <div className="bg-muted p-8 border-l-4 border-tertiary mb-10">
              ...
              <ul className="space-y-3">
                {["Financial services & Insurance", "Healthcare & Life Sciences", "Manufacturing & Supply Chain", "Retail & E-commerce", "Professional Services", "Many other industries"].map((industry, i) => <li key={i} className="flex items-center">
            ...
            <div className="flex items-center space-x-8 mb-12">
              <Link to="/industries" className="btn bg-tertiary text-white hover:bg-tertiary-light transition inline-flex text-left items-center">
                <span>Explore by industries</span>
                <ArrowRight className="w-4 h-4 ml-2" />
              </Link>
              <div className="text-sm text-dark/60 flex items-center px-[38px]">
          ...
          <div className="lg:col-span-7">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {features.map((feature, index) => <div key={index} className="exct-card p-6 bg-white hover:border-tertiary/20 hover:shadow-lg transition-all duration-300">
            ...
            <div className="mt-8 bg-muted/50 border border-gray-100 p-6 flex flex-col md:flex-row items-left justify-between">
              ...
              <div className="flex flex-wrap content-start gap-4">
                {["ISO 27001", "HIPAA", "GDPR", "SOC2", "PCI DSS"].map((cert, i) => <div key={i} className="bg-white px-3 py-1 text-xs border border-gray-200 shadow-sm">
                    {cert}
                  </div>)}
              </div>
            </div>
